...
namespace Adaptation
{
  ...
  hpFull<dim, VectorType, spacedim>::hpFull(
    const Parameter                                     &prm,
    ...
    , component_mask(component_mask)
  {
    ...
    // set future fe indices and limit p-level difference
  ...
  template <int dim, typename VectorType, int spacedim>
  void
  hpFull<dim, VectorType, spacedim>::estimate_mark()
  {
  ...
  template <int dim, typename VectorType, int spacedim>
  void
  hpFull<dim, VectorType, spacedim>::refine()
  {
  ...
  template <int dim, typename VectorType, int spacedim>
  void
  hpFull<dim, VectorType, spacedim>::prepare_for_serialization()
  {}
  ...
  template <int dim, typename VectorType, int spacedim>
  void
  hpFull<dim, VectorType, spacedim>::unpack_after_serialization()
  {}
  ...
  template <int dim, typename VectorType, int spacedim>
  unsigned int
  hpFull<dim, VectorType, spacedim>::get_n_cycles() const
  {
    return prm.n_cycles;
  }
  ...
  template <int dim, typename VectorType, int spacedim>
  unsigned int
  hpFull<dim, VectorType, spacedim>::get_n_initial_refinements() const
  {
  ...
  template <int dim, typename VectorType, int spacedim>
  const Vector<float> &
  hpFull<dim, VectorType, spacedim>::get_error_estimates() const
  {
  ...
  template <int dim, typename VectorType, int spacedim>
  const Vector<float> &
  hpFull<dim, VectorType, spacedim>::get_hp_indicators() const
  {
    return dummy;
  }
  ...
  template class hpFull<2, LinearAlgebra::distributed::BlockVector<double>, 2>;
  template class hpFull<3, LinearAlgebra::distributed::BlockVector<double>, 3>;
  template class hpFull<2, LinearAlgebra::distributed::Vector<double>, 2>;
  template class hpFull<3, LinearAlgebra::distributed::Vector<double>, 3>;

#ifdef DEAL_II_WITH_TRILINOS
  template class hpFull<2, TrilinosWrappers::MPI::BlockVector, 2>;
  template class hpFull<3, TrilinosWrappers::MPI::BlockVector, 3>;
  template class hpFull<2, TrilinosWrappers::MPI::Vector, 2>;
  template class hpFull<3, TrilinosWrappers::MPI::Vector, 3>;
#endif

#ifdef DEAL_II_WITH_PETSC
  template class hpFull<2, PETScWrappers::MPI::BlockVector, 2>;
  template class hpFull<3, PETScWrappers::MPI::BlockVector, 3>;
  template class hpFull<2, PETScWrappers::MPI::Vector, 2>;
  template class hpFull<3, PETScWrappers::MPI::Vector, 3>;
#endif
