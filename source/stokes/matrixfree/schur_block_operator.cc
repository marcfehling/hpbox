...
namespace StokesMatrixFree
{
  ...
  {
    schur_block_matrix.vmult(dst, src);
  }
    ...
    VectorType &diagonal) const
  {
    ...
    for (unsigned int n = 0; n < schur_block_matrix.n(); ++n)
      diagonal[n] = 1.0 / schur_block_matrix.diag_element(n);
  }
